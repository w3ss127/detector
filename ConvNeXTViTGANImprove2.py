...
def train_model(rank, world_size, config):
    ...
    for epoch in range(config.EPOCHS):
        ...
        if epoch in config.UNFREEZE_EPOCHS or (epoch == 26 and config.USE_SGD_FINE_TUNE):
            ...
            elif epoch == 26 and config.USE_SGD_FINE_TUNE:
...
def main():
    ...
    parser.add_argument('--train-path', type=str, default='./datasets')
    parser.add_argument('--image-size', type=int, default=224)
    parser.add_argument('--class-names', type=str, default='real,semi-synthetic,synthetic')
    parser.add_argument('--num-workers', type=int, default=4)
    parser.add_argument('--unfreeze-epochs', type=int, nargs='+', default=[1, 6, 16])
    ...
    parser.add_argument('--checkpoint-dir', type=str, default='improve2_checkpoints')
    ...
    parser.add_argument('--use-sgd-fine-tune', action='store_true', default=False)
